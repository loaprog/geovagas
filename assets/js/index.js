...
function initCompaniesCarousel() {
    ...
    const companies = [
        { name: 'Company 1', logo: 'assets/img/001-dark.png' },
        { name: 'Company 2', logo: 'assets/img/002-dark.png' },
        { name: 'Company 3', logo: 'assets/img/003-dark.png' },
        { name: 'Company 4', logo: 'assets/img/004-dark.png' },
        { name: 'Company 5', logo: 'assets/img/005-dark.png' },
        { name: 'Company 6', logo: 'assets/img/006-dark.png' },
    ];
