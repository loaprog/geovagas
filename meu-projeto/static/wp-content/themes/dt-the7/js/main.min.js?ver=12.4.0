...
/*!-Paginator*/
var me=t('.paginator[role="navigation"]'),ge=me.find("a.dots");ge.on("click",(function(){me.find("div:hidden").show().find("a").unwrap(),ge.remove()})),t(".share-buttons a.pinit-marklet").click((function(e){e.preventDefault(),t("#pinmarklet").remove();var i=document.createElement("script");i.setAttribute("type","text/javascript"),i.setAttribute("charset","UTF-8"),i.setAttribute("id","pinmarklet"),i.setAttribute("async","async"),i.setAttribute("defer","defer"),i.setAttribute("src","//static.pinterest.com/js/pinmarklet.js?r="+99999999*Math.random()),document.body.appendChild(i)})),
/*!-Scroll to Top*/
